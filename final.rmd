...
```
The decision tree predicts with `r accuracy`% accuracy. Each node contains a yes or no classification for either a factor or a logical comparator for a continuous variable.
