...
In 2019, there were 2,861,523 deaths.
```{r}
q <- query("select count(*) as count, race40, ager52, educ2003, sex from mortality group by race40, ager52, educ2003, sex order by count desc limit 15")
races <- list(
  "1" = "White"
)
ages <- list(
...
kable(q %>% select(count, race, age, education))
```
