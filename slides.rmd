...
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, out.width="100%",  fig.width = 9, fig.height = 6)
source("setup.r")
...
```{r, weekday_deaths, fig.cap="caption"}
...
```{r weekday_deaths_scaled, fig.cap="caption"}
plotter(deaths_by_day_plot_scaled())
```

---

```{r, months_deaths, fig.cap="caption"}
...
```{r, month_manner, fig.cap="caption"}
...
```{r plot_age_gender, fig.cap="caption"}
