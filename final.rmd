...
```{r plot_killer, fig.height = 7, fig.width = 10}
...
```{r plot_weekday_deaths, fig.height = 11, fig.width = 8}
...
```{r plot_month_deaths, fig.height = 11, fig.width = 8}
...
```{r plot_month_manner, fig.height = 11, fig.width = 8}
month_count_table()
...
```{r plot_conditions_text, fig.height = 11, fig.width = 8}
